...
using AG.Pos.Tenants.Dashboard.Dto;

namespace AG.Pos.Tenants.Dashboard
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Tenant_Dashboard)]
    public class TenantDashboardAppService : PosAppServiceBase, ITenantDashboardAppService
    {
