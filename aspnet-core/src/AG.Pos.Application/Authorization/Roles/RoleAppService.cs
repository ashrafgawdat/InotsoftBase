...
using AG.Pos.Authorization.Permissions;
using AG.Pos.Authorization.Permissions.Dto;
using AG.Pos.Authorization.Roles.Dto;

namespace AG.Pos.Authorization.Roles
{
    /// <summary>
    /// Application service that is used by 'role management' page.
    /// </summary>
    [AbpAuthorize(AppPermissions.Pages_Administration_Roles)]
    public class RoleAppService : PosAppServiceBase, IRoleAppService
    {
