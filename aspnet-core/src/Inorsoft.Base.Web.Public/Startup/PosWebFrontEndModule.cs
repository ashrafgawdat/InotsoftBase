...
namespace Inorsoft.Base.Web.Public.Startup
{
    [DependsOn(
        typeof(PosWebCoreModule)
    )]
    public class PosWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public PosWebFrontEndModule(IHostingEnvironment env, PosEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PosWebFrontEndModule).GetAssembly());
        }
    }
}
