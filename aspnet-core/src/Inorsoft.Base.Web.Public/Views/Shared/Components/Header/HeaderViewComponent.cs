...
using Inorsoft.Base.Web.Public.Startup;
using Inorsoft.Base.Web.Session;

namespace Inorsoft.Base.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : PosViewComponent
    {
