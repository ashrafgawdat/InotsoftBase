...
using MvvmHelpers;
using Inorsoft.Base.Authorization.Users.Profile;
using Inorsoft.Base.Authorization.Users.Profile.Dto;
using Inorsoft.Base.Commands;
using Inorsoft.Base.Core.Threading;
using Inorsoft.Base.Models.NavigationMenu;
using Inorsoft.Base.Services.Navigation;
using Inorsoft.Base.ViewModels.Base;
using Plugin.Media;
...
using Inorsoft.Base.Controls;
using Inorsoft.Base.Dto;
using Inorsoft.Base.Extensions;
using Inorsoft.Base.Localization;
using Inorsoft.Base.UI;
using Inorsoft.Base.UI.Assets;
using Inorsoft.Base.Views;
using DependencyResolver = Inorsoft.Base.Core.Dependency.DependencyResolver;

namespace Inorsoft.Base.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Pos";
