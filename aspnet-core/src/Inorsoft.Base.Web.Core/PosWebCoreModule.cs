...
using Inorsoft.Base.Web.Authentication.TwoFactor;
using Inorsoft.Base.Web.Chat.SignalR;
using Inorsoft.Base.Web.Configuration;
...
namespace Inorsoft.Base.Web
{
    ...
    public class PosWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public PosWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(PosApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PosWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(PosWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
