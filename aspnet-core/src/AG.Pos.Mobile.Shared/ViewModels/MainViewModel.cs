...
using MvvmHelpers;
using AG.Pos.Authorization.Users.Profile;
using AG.Pos.Authorization.Users.Profile.Dto;
using AG.Pos.Commands;
...
using AG.Pos.Controls;
using AG.Pos.Dto;
using AG.Pos.Extensions;
using AG.Pos.Localization;
using AG.Pos.UI;
using AG.Pos.UI.Assets;
using AG.Pos.Views;
using DependencyResolver = AG.Pos.Core.Dependency.DependencyResolver;
