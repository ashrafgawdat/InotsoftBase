...
using Inorsoft.Base.DemoUiComponents.Dto;

namespace Inorsoft.Base.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : PosAppServiceBase, IDemoUiComponentsAppService
    {
