...
using Inorsoft.Base.Authentication.TwoFactor.Google;
using Inorsoft.Base.Authorization.Users.Dto;
using Inorsoft.Base.Authorization.Users.Profile.Cache;
using Inorsoft.Base.Authorization.Users.Profile.Dto;
using Inorsoft.Base.Dto;
using Inorsoft.Base.Friendships;
using Inorsoft.Base.Gdpr;
using Inorsoft.Base.Identity;
using Inorsoft.Base.Security;
using Inorsoft.Base.Storage;
using Inorsoft.Base.Timing;

namespace Inorsoft.Base.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : PosAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Inorsoft.Base",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("Inorsoft.Base",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
