...
using Inorsoft.Base.Migrations.Seed;
using Inorsoft.Base.Migrations.Seed.Host;
...
namespace Inorsoft.Base.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : PosAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<PosDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(PosConsts.ConnectionStringName).Value.ToString();
        }
